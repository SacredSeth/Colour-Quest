...
import random
from tkinter import *
from functools import partial  # unwanted windows
...
class StartGame:
    ...
    def check_rounds(self):
        """
        checks that user enters a valid number of rounds
        ...
        # checks that amount of rounds is valid
        try:
            rounds_wanted = int(rounds_wanted)
            if rounds_wanted > 0:
                # Clear entry box and reset instruction label
                # to avoid opening to an error
...
class Play:
    ...
    def __init__(self, how_many):
        ...
        # create four buttons in 2 x 2 grid
    ...
    def round_results(self, user_choice):
        ...
        # add one top the number of rounds played and retrieve
        ...
        # get target score and compare with user score to find round result
        ...
        if rounds_played == rounds_wanted:
            ...
            self.end_game_button.config(text="Play Again", bg="#006600", width=21)
...
class DisplayHints:
    ...
    def __init__(self, partner, rounds_played):
        ...
        # disable help, stats, and end game buttons
        partner.hints_button.config(state=DISABLED)
        partner.end_game_button.config(state=DISABLED)
        partner.stats_button.config(state=DISABLED)
        ...
        hint_instructions = ("The score for each colour relates to it's "
                             "hexadecimal code.\n"
                             "\nRemember, the hex code for white is #FFFFFF "
                             "- which is the best possible score.\n"
                             "\nThe hex code for black is #000000 which is "
                             "the worst possible score.\n"
                             "\nThe first colour in the code is red, so if you "
                             "had to choose between red (#FF0000), green (#00FF00), "
